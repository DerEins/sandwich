...
{   
    ...
    printf("VALIDE !\n");
    printf("Test de l'etat des cellules (blanches ou noires) et de la taille du tableau de world....");
    int b = 1;
    ...
    if(b==0)
    {
        fprintf(stderr, "ÉCHOUÉ : il y a une valeur qui n'appartient pas à l'ensemble {O,B} \n");
        exit(EXIT_FAILURE);
    }
    printf("VALIDE !\n");
    ...
    if(compare_cte_array(WIDTH * HEIGHT, w1.t, w2.t))
    {
        ...
        fprintf(stderr, "ECHOUE : Les mondes ne sont pas generes de maniere aleatoire \n");
